...
<div class="container bootstrap snippet">
    <div class="row">
  		<div class="col-sm-10"><h1>Settings</h1></div>
...
if(isset($_POST['get_image']))
{
 ...
 $new = 'uploads/new_image.jpg';
 file_put_contents($new, $data);
//  echo "<img src='uploads/new_image.jpg'>";
 echo"<img src='uploads/new_image.jpg' class=\"avatar img-circle img-thumbnail\" alt=\"avatar\">";
}
error_reporting(0);
...
<h6>Upload a different photo...</h6>
        ...
        <br>
        <h6>Or Import Image from URL</h6>
        <form method="post" action="settings.php">
        <input type="text" name="img_url" class="form-control" placeholder="Enter Image URL">
        <br>
        <input type="submit" name="get_image" class="btn btn-lg btn-primary" value="Submit">
        </form>
